...
public final class AuthServiceGrpc {
  ...
  public static final String SERVICE_NAME = "ru.pobopo.weather.grpc.AuthService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<ru.pobopo.weather.grpc.Credits,
      com.google.protobuf.BoolValue> METHOD_AUTH_USER =
      io.grpc.MethodDescriptor.<ru.pobopo.weather.grpc.Credits, com.google.protobuf.BoolValue>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "ru.pobopo.weather.grpc.AuthService", "AuthUser"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              ru.pobopo.weather.grpc.Credits.getDefaultInstance()))
  ...
  public static abstract class AuthServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void authUser(ru.pobopo.weather.grpc.Credits request,
        io.grpc.stub.StreamObserver<com.google.protobuf.BoolValue> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_AUTH_USER, responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ru.pobopo.weather.grpc.Credits,
                com.google.protobuf.BoolValue>(
                  this, METHODID_AUTH_USER)))
          .build();
    }
  }
  ...
  public static final class AuthServiceStub extends io.grpc.stub.AbstractStub<AuthServiceStub> {
    ...
    public void authUser(ru.pobopo.weather.grpc.Credits request,
        io.grpc.stub.StreamObserver<com.google.protobuf.BoolValue> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_AUTH_USER, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class AuthServiceBlockingStub extends io.grpc.stub.AbstractStub<AuthServiceBlockingStub> {
    ...
    /**
     */
    public com.google.protobuf.BoolValue authUser(ru.pobopo.weather.grpc.Credits request) {
      return blockingUnaryCall(
          getChannel(), METHOD_AUTH_USER, getCallOptions(), request);
    }
  }
  ...
  public static final class AuthServiceFutureStub extends io.grpc.stub.AbstractStub<AuthServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.BoolValue> authUser(
        ru.pobopo.weather.grpc.Credits request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_AUTH_USER, getCallOptions()), request);
    }
  }

  private static final int METHODID_AUTH_USER = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AUTH_USER:
          serviceImpl.authUser((ru.pobopo.weather.grpc.Credits) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.BoolValue>) responseObserver);
          break;
        default:
  ...
  private static final class AuthServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.pobopo.weather.grpc.Auth.getDescriptor();
    }
  }
